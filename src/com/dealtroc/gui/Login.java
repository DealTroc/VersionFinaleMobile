...
import com.dealtroc.gui.uikit.NewsfeedForm;
import com.dealtroc.gui.uikit.SignUpForm;
...
public class Login extends BaseForm {
    ...
    private void addGUIs() {
        ...
        backendBtn.addActionListener(l -> new com.dealtroc.gui.back.AccueilBack(this).show());
        ...
        signIn.requestFocus();
        signIn.addActionListener(e -> new AfficherToutProduit(MainApp.res).show());
    }
