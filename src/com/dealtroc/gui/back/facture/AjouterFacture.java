...
public class AjouterFacture extends Form {
    ...
    public AjouterFacture(Form previous) {
    ...
    private void addActions() {
        ...
        manageButton.addActionListener(action -> {
            if (controleDeSaisie()) {
                int responseCode = FactureService.getInstance().add(
                        new Facture(
                ...
                if (responseCode == 200) {
                    AlertUtils.makeNotification("Facture ajouté avec succes");
                    showBackAndRefresh();
                } else {
                    Dialog.show("Erreur", "Erreur d'ajout de facture. Code d'erreur : " + responseCode, new Command("Ok"));
                }
            }
        });
    }
