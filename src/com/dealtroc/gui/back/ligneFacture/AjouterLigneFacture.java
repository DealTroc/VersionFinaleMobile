...
public class AjouterLigneFacture extends Form {
    ...
    public AjouterLigneFacture(Form previous) {
    ...
    private void addActions() {
        ...
        manageButton.addActionListener(action -> {
            if (controleDeSaisie()) {
                int responseCode = LigneFactureService.getInstance().add(
                        new LigneFacture(
                ...
                if (responseCode == 200) {
                    AlertUtils.makeNotification("LigneFacture ajouté avec succes");
                    showBackAndRefresh();
                } else {
                    Dialog.show("Erreur", "Erreur d'ajout de ligneFacture. Code d'erreur : " + responseCode, new Command("Ok"));
                }
            }
        });
    }
